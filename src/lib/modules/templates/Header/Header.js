...
<div className="header-top">
  ...
  <div className="container">
    ...
    <ul className="header-social-container">
      ...
      <li>
        <a href="https://www.facebook.com/iftiyaazmirzim?__cft__[0]=AZWznjLcbB4brstwXCCfqfTxGnncnOffHdvt373i7CVyTm4RpzrAy73IdxITXd8GhXjJT2t1WilBZybjCXYIIjEGGBTRs4AZKFOFuO2LVKVxwf2h4rAkXPL2-Gn2IST_DJYRjsfZsWgI48D2DWHXvCEqM8wv9KrJSlFbk8a4IJuCGw&__tn__=%3C%3C%2CP-R" target="_blank" className="social-link">
...
<div className="header-main">
  ...
  <div className="container">
    ...
    <a href="#" className="header-logo">Iftiya's Dress Fair</a>
